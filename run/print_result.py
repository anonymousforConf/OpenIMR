...
print(("Overall_Acc: {}, Seen_Acc: {}, Novel_Acc: {}, Imbalance rate (Avg.): {}, Separation rate (Avg.): {}").format(avg_all / num, avg_old / num, avg_new / num, avg_imbalance_rate / num, avg_separate_rate / num))
